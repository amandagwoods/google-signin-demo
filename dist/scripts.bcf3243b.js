...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/auth.esm.js"}],"scripts/utils.js":[function(require,module,exports) {
"use strict";
...
var googleSignOut = function googleSignOut() {
  _app.default.auth().signOut().then(function () {
    ...
    return console.error("There was an error while signing out: ", error);
  });
};
...
(0, _utils.clickHandler)("signIn-google", _firebaseAuthentication.googleSignIn);
(0, _utils.clickHandler)("app-signOut", _firebaseAuthentication.googleSignOut);
},{"./firebase/firebaseConfig":"scripts/firebase/firebaseConfig.js","./utils":"scripts/utils.js","./firebase/firebaseAuthentication":"scripts/firebase/firebaseAuthentication.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
